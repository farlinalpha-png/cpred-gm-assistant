...
const NC_MAP_DATA = [
  ...
  },
  {
    ...
    "region": "The Island",
    "description": "A sprawling mix of industry and residential buildings. Itisa combat zone primarily because the city manager, Gaven Haakensen, cares more about lining his pockets than he does doing his job. That doesn’t make him unusual, but he’s more blatant about it than most.",
  ...
  },
  {
    ...
    "region": "The Island",
    "description": "A central location for cargo entering and leaving Night City by sea. Run by nomads from the Thelas Nation.",
  ...
  },
  {
    ...
    "region": "The Island",
    "description": "In the late 2010s and early 2020s, Night City began expanding the Island by filling in land to the southeast. In the aftermath of the 4th Corporate War, what was intended tobea shining beacon of industrial might devolved into the worst combat zone Night City had ever seen. Slowly, inch by inch, groups of edgerunners have strived to rebuild it.",
  ...
  },
  {
    ...
    "region": "Northside",
    "description": "Home of the Estero Bay Military COG (a mixture of various military units into a single organized group). In theory, the COG is loyal to Nor Cal and the Pacifica Confederation, but they’ve also made a deal with Militech, trading land and access for training and munitions.",
    "cityManager": "General Ash Giovanni (base commander)",
    "securityProvider": "Nor Cal Military Police",
    "gangs": [
      "Culper Ring"
    ],
    "locations": [
  ...
  },
  {
    ...
    "cityManager": "Belkis Abera (appointed by World Sat and Network 54)",
    "securityProvider": "NCPD",
    "gangs": [
      "Arzin Tynon",
      "Prime-Time Players",
  ...
  },
  {
    ...
    "region": "Southside",
    "description": "A district built around Playland by the Sea.",
